...
function localReview(data) {
  ...
  if (data.language === "Hindi") {
    return `à¤®à¥ˆà¤‚ ${concern} à¤•à¥‡ à¤²à¤¿à¤ ${CLINIC_NAME} à¤—à¤¯à¤¾/à¤—à¤ˆà¥¤ à¤®à¥‡à¤°à¤¾ overall rating experience ${avg.toFixed(1)}/5 à¤°à¤¹à¤¾à¥¤ à¤¡à¥‰à¤•à¥à¤Ÿà¤° à¤•à¥€ listening ${ratingTone(data.doctorApproachRating)} à¤²à¤—à¥€, treatment experience ${ratingTone(data.treatmentEffectivenessRating)} à¤°à¤¹à¤¾, clinic cleanliness ${ratingTone(data.clinicAmbienceRating)} à¤²à¤—à¥€, staff behavior ${ratingTone(data.staffBehaviorRating)} à¤°à¤¹à¤¾, à¤”à¤° value for money ${ratingTone(data.valueForMoneyRating)} à¤²à¤—à¤¾à¥¤${data.likedMost ? ` à¤®à¥à¤à¥‡ à¤–à¤¾à¤¸ à¤¤à¥Œà¤° à¤ªà¤° ${data.likedMost} à¤…à¤šà¥à¤›à¤¾ à¤²à¤—à¤¾à¥¤` : ""}${good ? " à¤•à¥à¤² à¤®à¤¿à¤²à¤¾à¤•à¤° à¤…à¤¨à¥à¤­à¤µ à¤…à¤šà¥à¤›à¤¾ à¤°à¤¹à¤¾à¥¤" : mixed ? " à¤•à¥à¤² à¤®à¤¿à¤²à¤¾à¤•à¤° à¤…à¤¨à¥à¤­à¤µ à¤®à¤¿à¤²à¤¾-à¤œà¥à¤²à¤¾ à¤°à¤¹à¤¾ à¤”à¤° à¤•à¥à¤› à¤¸à¥à¤§à¤¾à¤° à¤•à¥€ à¤—à¥à¤‚à¤œà¤¾à¤‡à¤¶ à¤¹à¥ˆà¥¤" : " à¤•à¥à¤² à¤®à¤¿à¤²à¤¾à¤•à¤° à¤…à¤¨à¥à¤­à¤µ à¤¸à¤‚à¤¤à¥‹à¤·à¤œà¤¨à¤• à¤¨à¤¹à¥€à¤‚ à¤°à¤¹à¤¾ à¤”à¤° à¤¸à¥à¤§à¤¾à¤° à¤•à¥€ à¤œà¤°à¥‚à¤°à¤¤ à¤¹à¥ˆà¥¤"}`;
  }

  if (data.language === "Gujarati") {
    return `àª¹à«àª‚ ${concern} àª®àª¾àªŸà«‡ ${CLINIC_NAME} àª—àª¯à«‹/àª—àªˆ àª¹àª¤à«‹/àª¹àª¤à«€. àª®àª¾àª°à«‹ overall rating experience ${avg.toFixed(1)}/5 àª°àª¹à«àª¯à«‹. Doctor listening ${ratingTone(data.doctorApproachRating)} àª¹àª¤à«€, treatment experience ${ratingTone(data.treatmentEffectivenessRating)} àª°àª¹à«àª¯à«‹, clinic cleanliness ${ratingTone(data.clinicAmbienceRating)} àª¹àª¤à«€, staff behavior ${ratingTone(data.staffBehaviorRating)} àª°àª¹à«àª¯à«‹, àª…àª¨à«‡ value for money ${ratingTone(data.valueForMoneyRating)} àª²àª¾àª—à«àª¯à«àª‚.${data.likedMost ? ` àª®àª¨à«‡ àª–àª¾àª¸ àª•àª°à«€àª¨à«‡ ${data.likedMost} àª—àª®à«àª¯à«àª‚.` : ""}${good ? " àª•à«àª² àª®àª³à«€àª¨à«‡ àª…àª¨à«àª­àªµ àª¸àª¾àª°à«‹ àª°àª¹à«àª¯à«‹." : mixed ? " àª•à«àª² àª…àª¨à«àª­àªµ àª®àª¿àª¶à«àª° àª°àª¹à«àª¯à«‹ àª…àª¨à«‡ àª¥à«‹àª¡à«‹ àª¸à«àª§àª¾àª°à«‹ àª¥àªˆ àª¶àª•à«‡ àª›à«‡." : " àª•à«àª² àª…àª¨à«àª­àªµ àª¸àª‚àª¤à«‹àª·àª•àª¾àª°àª• àª¨àª¹à«‹àª¤à«‹ àª…àª¨à«‡ àª¸à«àª§àª¾àª°àª¾àª¨à«€ àªœàª°à«‚àª° àª›à«‡."}`;
  }

  if (data.language === "Marathi") {
    return `à¤®à¥€ ${concern} à¤¸à¤¾à¤ à¥€ ${CLINIC_NAME} à¤²à¤¾ à¤­à¥‡à¤Ÿ à¤¦à¤¿à¤²à¥€. à¤®à¤¾à¤à¤¾ overall rating experience ${avg.toFixed(1)}/5 à¤¹à¥‹à¤¤à¤¾. Doctor listening ${ratingTone(data.doctorApproachRating)} à¤µà¤¾à¤Ÿà¤²à¥‡, treatment experience ${ratingTone(data.treatmentEffectivenessRating)} à¤¹à¥‹à¤¤à¤¾, clinic cleanliness ${ratingTone(data.clinicAmbienceRating)} à¤µà¤¾à¤Ÿà¤²à¥€, staff behavior ${ratingTone(data.staffBehaviorRating)} à¤¹à¥‹à¤¤à¤¾, à¤†à¤£à¤¿ value for money ${ratingTone(data.valueForMoneyRating)} à¤µà¤¾à¤Ÿà¤²à¥‡.${data.likedMost ? ` ${data.likedMost} à¤–à¤¾à¤¸ à¤†à¤µà¤¡à¤²à¥‡.` : ""}${good ? " à¤à¤•à¥‚à¤£ à¤…à¤¨à¥à¤­à¤µ à¤šà¤¾à¤‚à¤—à¤²à¤¾ à¤¹à¥‹à¤¤à¤¾." : mixed ? " à¤à¤•à¥‚à¤£ à¤…à¤¨à¥à¤­à¤µ à¤®à¤¿à¤¶à¥à¤° à¤¹à¥‹à¤¤à¤¾ à¤†à¤£à¤¿ à¤•à¤¾à¤¹à¥€ à¤¸à¥à¤§à¤¾à¤°à¤£à¤¾ à¤¹à¥‹à¤Š à¤¶à¤•à¤¤à¤¾à¤¤." : " à¤à¤•à¥‚à¤£ à¤…à¤¨à¥à¤­à¤µ à¤¸à¤®à¤¾à¤§à¤¾à¤¨à¤•à¤¾à¤°à¤• à¤¨à¤µà¥à¤¹à¤¤à¤¾ à¤†à¤£à¤¿ à¤¸à¥à¤§à¤¾à¤°à¤£à¤¾ à¤—à¤°à¤œà¥‡à¤šà¥€ à¤†à¤¹à¥‡."}`;
  }
